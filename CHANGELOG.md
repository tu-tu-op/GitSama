...
All notable GitSama changes are recorded here.

## 0.1.0

Initial release:

- local, per-user Git reactions for commit, push, massive push, merge, branch switch, branch create, branch delete, and rebase
